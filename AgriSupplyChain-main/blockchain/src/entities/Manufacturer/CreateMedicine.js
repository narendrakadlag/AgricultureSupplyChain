...
import Medicine from '../../build/Crop.json';
  ...
  return (
    <Grid container style={{ backgroundColor: "white", display: "center", alignItems: "center", maxWidth: 400, justify: "center"}}>
        ...
        <div className={classes.paper}>
          ...
          <Typography component="h1" variant="h5">Add New Crop</Typography>
          <form className={classes.form} noValidate>
          <Grid container spacing={2}>

            <Grid item xs={12}>
                <TextField variant="outlined" onChange={ handleInputChange } required fullWidth  id="description" label="Crop Description" name="description"/>
            </Grid>
            <Grid item xs={12}>
                <TextField variant="outlined" onChange={ handleInputChange } required fullWidth  id="quantity" label="Crop Quantity" name="quantity"/>
            </Grid>
            <Grid item xs={12}>
